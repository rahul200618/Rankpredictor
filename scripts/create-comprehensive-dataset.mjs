...
function main() {
  ...
  console.log('Creating comprehensive dataset with 200,000+ entries...');
  ...
  // Filter proto data to only include 2023 data
  ...
  const comprehensiveFile = path.join(outDir, 'cutoffs-comprehensive.json');
  fs.writeFileSync(comprehensiveFile, JSON.stringify(finalData, null, 2), 'utf8');
  ...
  console.log(`Data saved to: ${comprehensiveFile}`);
