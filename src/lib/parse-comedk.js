...
Odd_Link_449	89	8777		
ChemistExotic1723	89	12767		✔		
...
for (let i = 1; i < lines.length; i++) {
  ...
  if (parts.length >= 3) {
    ...
    if (!isNaN(rank)) {
      points.push(\`  { marks: \${marks}, rank: \${rank}, source: "post" },\`);
    }
  }
}

fs.writeFileSync('C:\\\\Users\\\\risha\\\\OneDrive\\\\Desktop\\\\coded-main\\\\src\\\\lib\\\\comedk-parsed-data.txt', points.join('\n'));
console.log('Done!');
